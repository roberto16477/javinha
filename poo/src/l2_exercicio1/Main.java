...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Salário inicial do empregado: " + empregado.getSalario());
        ...
        System.out.println("\nSalário inicial do chefe: " + chefe.getSalario());
        ...
        System.out.println("\nSalário inicial do estagiário: " + estagiario.getSalario());
